            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                <img 
                  ...
                  alt="Resume Sample" 
                  className="w-80 h-auto hover:animate-spin-horizontal shadow-2xl rounded-lg hover:shadow-3xl hover:glow-effect transition-all duration-300"
                />
                <div className="absolute -top-4 -right-4 bg-green-500 text-white px-3 py-1 rounded-full text-sm font-semibold transform rotate-12 animate-pulse">
                  HIRED
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <div key={step.number} className="text-center group">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                  {step.number}
                </div>
                <h3 className="text-xl font-semibold mb-2 group-hover:text-blue-600 transition-colors">{step.title}</h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <Card key={index}>
                <div className="text-4xl mb-4 transform hover:scale-125 transition-transform duration-300">{feature.icon}</div>
